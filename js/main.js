$(function(){
    ...
    $(".item").each(function(i, item) {
        ...
        item.find(".name").keyup(function(){changing(item);})
    });
    ...
    function newItem() {
        ...
        if (title != "") {
            var found = false;
            $(".name_crossed").each(function(i, item) {
                var name = $(item).text();
                if (name == title) {
                    $(this).parent().parent().find(".in").click();
                    found = true;
                }
            });
            if(!found){
    ...
    function changing(node){
        var name = node.find(".name_crossed").text();
        $(".liname").each(function(i, item) {
            var name = $(item).text();
            if (name == node.find(".name_crossed").text()) {
                $(item).text(node.find(".name").val());
            }
        });
        node.find(".name_crossed").text(node.find(".name").val());
    }
    ...
    function addItem(title){
        ...
        node.find(".name").keyup(function(){changing(node);});
